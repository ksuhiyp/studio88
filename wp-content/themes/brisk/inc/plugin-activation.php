...
function uicore_get_plugins(){
    return array(
        ...
        array(
            ...
            'version'            => UICORE_THEME_VERSION, // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
