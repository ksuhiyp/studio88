...
class Skin_Stack extends Elementor_Skin_Base {
	...
	public function render() {
		...
		if ( 'style1' == $settings['fancy_card_icon_style'] ) {
			$this->parent->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-stack bdt-fancy-icon-style1' );
		} elseif ( 'style2' == $settings['fancy_card_icon_style'] ) {
			$this->parent->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-stack bdt-fancy-icon-style2' );
		} elseif ( 'style3' == $settings['fancy_card_icon_style'] ) {
			$this->parent->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-stack bdt-fancy-icon-style3' );
		} elseif ( 'style4' == $settings['fancy_card_icon_style'] ) {
			$this->parent->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-stack bdt-fancy-icon-style4' );
		} else {
			$this->parent->add_render_attribute( 'fancy-card', 'class', 'bdt-fancy-card bdt-skin-stack' );
		}
		...
		<div <?php echo $this->parent->get_render_attribute_string( 'fancy-card' ); ?>>
			...
			<div class="bdt-content-overlay"></div>
