...
class Settings
{
	...
	{
		$new = ThemeOptions::get_all();
		if (!self::is_migrated()) {
			$settings = [];
			foreach (Settings::get_settings_list() as $field => $options) {
				$settings[$field] = get_option(Settings::get_prefix() . $field, $options);
			}
			self::settings_migrate_to_v3($settings);
			$settings = wp_parse_args($settings, $new);
		} else {
			$settings = $new;
		}
	...
	{
		$colors_array = ['Primary', 'Secondary', 'Accent', 'Headline', 'Body', 'Dark Neutral', 'Light Neutral'];
	...
	public static function get_settings_list(): array
	{
		$settings =
            ...
            "gen_maintenance_page":"default",
            "gen_themecolor":"true",
            "gen_themecolorcode":"#FFFFFF",
            ...
            "logoS":"https://brisk.uicore.co/original/wp-content/uploads/sites/33/2020/03/original-logo-white.png",
            "logoMobile":"",
            "logoSMobile":"",
            "fav":"",
            "pColor":"#00C49A",
            ...
            "header_topone_content":"<p>Get <strong>50% off</strong> on Brisk theme. Limited time offer</p>",
            ...
            "mobile_menu_bg":{
               ...
               "image":{
                  "url":"https://brisk.uicore.co/original/wp-content/uploads/sites/33/2020/09/original-mobile-menu-bg.png",
                  "attachment":"fixed",
                  "position":{
                     "d":"bottom center",
                     "t":"center center",
            ...
            "copyrights":"true",
            "copyrights_content":"<p class=\"p1\"><span class=\"s1\">&copy; UiCore 2020 All Rights Reserved.</span></p>",
            "copyrights_padding":{
               "d":"40",
               "t":"40",
               "m":"30"
            ...
            "woocommerce_sidebars":"false",
            "woocommerces_sidebar_id":"none",
            "woocommerces_sidebar":"left",
            "woocommerces_sidebars":"false",
            "social_fb":"",
            "social_tw":"",
            "social_yt":"",
            "social_in":"",
	...
	static function settings_migrate_to_v3($settings)
	{
      $prefix = Settings::get_prefix();
		//will use this to get all settings (new and current combined)
		//to use it in style generator
		//eg. in import some keys are deteled.
		foreach (Settings::get_settings_list() as $field => $options) {

			//continue only if this setting key exist in new array
			if (isset($settings[$field])) {
				$value = $settings[$field];
				//update even if is the same value, just to be sure
				update_option($prefix . $field, $value, false);
			}
		}
		update_option('uicore_v3_migrated', true);
	}

	static function is_migrated()
	{
		return get_option('uicore_v3_migrated');
	}
   ...
   static function get_settings_data()
   {
      return array (
         ...
         array (
           ...
           'desc' => _x('Change header padding after scoll.', 'Admin - Theme Options', 'uicore-framework'),
           'category' => _x('Header', 'Admin - Theme Options', 'uicore-framework'),
         ...
         array (
           ...
           'desc' => _x('Set the left and right padding for menu items.', 'Admin - Theme Options', 'uicore-framework'),
           'category' => _x('Header', 'Admin - Theme Options', 'uicore-framework'),
         ...
         array (
           'id' => 71,
           'adv' => true,
           'name' => _x('Dropdown Menu Color', 'Admin - Theme Options', 'uicore-framework'),
           'desc' => _x('Set the dropdown menu text colors.', 'Admin - Theme Options', 'uicore-framework'),
           'category' => _x('Header', 'Admin - Theme Options', 'uicore-framework'),
           'tags' => _x('dropdown menu color', 'Admin - Theme Options Search', 'uicore-framework'),
           'dependecies' => NULL,
           'visible' => true,
         ),
         72 =>
         ...
         array (
           ...
           'desc' => _x('Adds box shadow on header.', 'Admin - Theme Options', 'uicore-framework'),
           'category' => _x('Header', 'Admin - Theme Options', 'uicore-framework'),
         ...
         array (
           ...
           'desc' => _x('Hide the decumentation icon on top right.', 'Admin - Theme Options', 'uicore-framework'),
           'category' => _x('Admin Customizer', 'Admin - Theme Options', 'uicore-framework'),
