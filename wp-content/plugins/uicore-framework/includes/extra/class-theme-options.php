...
class ThemeOptions {
	...
	public static function admin_defaults() {
		self::$defaults_admin = [
			...
			'performance_smart_preload'	=> 'true',
			'performance_widgets'		=> 'true',
	...
	/**
	 * Save NonDefault options in db and return the new settings array
	 *
	 * @return mixed
	 * @author Andrei Voica <andrei@uicore.co>
	 * @since 3.0.0
	...
	public static function update_all($settings) {
		...
		self::$db_options_no_defaults_front['settings_version'] = rand(1000, 9999);

		update_option( UICORE_SETTINGS, self::$db_options_no_defaults_front,true);
		update_option( UICORE_SETTINGS.'_admin', self::$db_options_no_defaults_admin,true);
