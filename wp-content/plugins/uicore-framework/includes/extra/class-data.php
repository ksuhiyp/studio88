...
class Data
{
    ...
    public static function get_recomended_plugins() : array
    {
        ...
        $plugins = [
                ...
                'envato-market/envato-market.php' => [
                    ...
                    'name' => 'Envato Market',
                    'slug' => 'envato-market',
                    'description' => 'This plugin helps customers receive updates to their premium Themes & Plugins purchased through Envato Market.',
                    'active' => is_plugin_active('envato-market/envato-market.php'),
                    'installed' => check_plugin_installed('envato-market/envato-market.php'),
                ],
    ...
    public static function get_theme_builder_data()
    {
        ...
        $data = array(
            'conditions'=> ThemeBuilder\Common::get_location_selections(),
    ...
    static function get_theme_options_generic_strings()
    {
        return [
            ...
            "import"=>[
                ...
                "text" => sprintf(
                            _x('Before running Demo Import, make sure %s Server Staus %s is all green. If any values
