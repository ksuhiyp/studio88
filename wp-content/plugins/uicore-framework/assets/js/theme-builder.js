...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_570e8ece_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_color_vue__ = __webpack_require__(72);
var disposed = false
...
var _vueColor = __webpack_require__(18);
...
var _uicoreMiniToggle = __webpack_require__(8);
...
exports.default = {
    props: ['background', 'isglobal', 'blur'],
    components: {
    ...
    data: function data() {
        return {
            ...
            types: [{
                type: 'Global Colors',
                items: ['Primary', 'Secondary', 'Accent', 'Headline', 'Body', 'Dark Neutral', 'Light Neutral']
            }, {
                type: 'Custom Color',
                items: ['Solid']
            }]
...
var _rule = __webpack_require__(341);
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            mode: 'Item',
            type: 'New',
            typeList: ['header', 'footer', 'mega menu', 'popup', 'block'],
...
var render = function() {
  ...
  return _c("div", {
    domProps: {
      innerHTML: _vm._s(__webpack_require__(21)("./icon-" + this.icon + ".svg"))
    },
    on: {
...
var map = {
	"./icon-admin-customizer.svg": 22,
	"./icon-animations.svg": 23,
	"./icon-blog.svg": 24,
	"./icon-branding.svg": 25,
	"./icon-buttons.svg": 26,
	"./icon-close.svg": 27,
	"./icon-custom.svg": 28,
	"./icon-dark-mode.svg": 29,
	"./icon-dashboard.svg": 30,
	"./icon-demo-loader.svg": 31,
	"./icon-desktop.svg": 32,
	"./icon-documentation.svg": 33,
	"./icon-edit.svg": 34,
	"./icon-feedback.svg": 35,
	"./icon-footer.svg": 36,
	"./icon-general.svg": 37,
	"./icon-global-colors.svg": 38,
	"./icon-global-fonts.svg": 39,
	"./icon-global.svg": 40,
	"./icon-header.svg": 41,
	"./icon-import-preset.svg": 42,
	"./icon-import.svg": 43,
	"./icon-light-mode.svg": 44,
	"./icon-page-title.svg": 45,
	"./icon-performance.svg": 46,
	"./icon-phone.svg": 47,
	"./icon-plugins.svg": 48,
	"./icon-portfolio.svg": 49,
	"./icon-preset.svg": 50,
	"./icon-presetm.svg": 51,
	"./icon-remove-preset.svg": 52,
	"./icon-search.svg": 53,
	"./icon-social.svg": 54,
	"./icon-success.svg": 55,
	"./icon-system.svg": 56,
	"./icon-tablet.svg": 57,
	"./icon-theme-skin.svg": 58,
	"./icon-top-banner.svg": 59,
	"./icon-typography.svg": 60,
	"./icon-updates.svg": 61,
	"./icon-warning.svg": 62,
	"./icon-woo.svg": 63
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bd6236d4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SvgIcon_vue__ = __webpack_require__(20);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
var _ThemeBuilder = __webpack_require__(339);
...
var _vue2PerfectScrollbar = __webpack_require__(79);

var _vue2PerfectScrollbar2 = _interopRequireDefault(_vue2PerfectScrollbar);

var _uicoreMultiselect = __webpack_require__(345);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_57cbf9ba_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ThemeBuilder_vue__ = __webpack_require__(344);
var disposed = false
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_396a6726_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_rule_vue__ = __webpack_require__(343);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
                    ...
                    directives: [
                      {
                        ...
                        value:
                          ...
                          _vm.itemType === "footer",
                        expression:
                          "itemType === 'header' || itemType === 'footer'"
                      }
                    ],
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uicoreMultiselect_vue__ = __webpack_require__(153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3acb0aa1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uicoreMultiselect_vue__ = __webpack_require__(346);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_de6b95f6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Popup_vue__ = __webpack_require__(75);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var _vuexRestApi = __webpack_require__(78);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_33203615_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uicore_mini_toggle_vue__ = __webpack_require__(71);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
